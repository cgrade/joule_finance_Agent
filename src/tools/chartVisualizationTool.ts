...
export class ChartVisualizationTool {
   ...
   */
  async createChart(data: any, title: string, type: string = "bar"): Promise<string> {
    try {
   ...
   */
  private drawBarChart(ctx: any, data: any): void {
    // Extract asset data
   ...
   */
  private drawLineChart(ctx: any, data: any): void {
   ...
   */
  private drawPieChart(ctx: any, data: any): void {
   ...
   */
  private drawLeverageChart(ctx: any, data: any): void {
    ...
    const values = Object.values(leverageData) as number[];
